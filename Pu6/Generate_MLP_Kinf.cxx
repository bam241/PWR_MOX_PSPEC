...
/**********************Fresh fuel**************************************************/
	...
	fOutT->Branch(	"pu6_e"			,&pu6_e			,"pu6_e/D"			);
...
/**********************FILLING THE TTREE**************************************************/
	...
	{ 
		...
		///////////////////////////////////////////////////////
	 			...
	 			cout << b << " Pu6 " << fpu6[b].size() << endl;
	 			cout << b << " Time " <<fTime[b].size() << endl;
...
{	//Read a .dat file and fill XS maps and the fuel initial composition
	...
	{	
		...
		if(a!=0 && z!=0)
		{
            ...
            if ( z == 94  && a == 236 )
            {
             // cout << " z "<< z << " a " << a << " i " << i << endl;
              vpu6.push_back(q);
              while(start < (int)line.size())
                vpu6.push_back(atof(StringLine::NextWord(line, start, ' ').c_str()));
              fpu6.push_back(vpu6);
            }
		}
